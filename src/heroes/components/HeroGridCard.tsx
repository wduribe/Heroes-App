        ...
        <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-linear-to-br from-white to-gray-50">
            <div className="relative h-64">
                <img
                    src={hero.image}
                    alt={hero.name}
                    className="object-cover top-[-30px] h-[410px] w-full absolute transition-all duration-500  group-hover:scale-110"
                    onClick={handleClick}
                />
            ...
            <CardHeader className="py-3 z-10 bg-gray-100/50 backdrop-blur-sm relative top-1 group-hover:top-6 transition-all duration-500">
